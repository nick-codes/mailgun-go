...
[![GoDoc](https://godoc.org/github.com/nick-codes/mailgun-go?status.svg)](https://godoc.org/github.com/nick-codes/mailgun-go)
[![Build Status](https://img.shields.io/travis/nick-codes/mailgun-go/master.svg)](https://travis-ci.org/nick-codes/mailgun-go)
...
import (
	...
	"github.com/nick-codes/mailgun-go/v4"
)
...
```bash
$ go get github.com/nick-codes/mailgun-go/v4
```
...
```bash
$ go get github.com/nick-codes/mailgun-go
```
...
```
"github.com/nick-codes/mailgun-go/v4/events", which contains malformed code: no package exists at ...
```
